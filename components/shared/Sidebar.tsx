...
const Sidebar: React.FC<SidebarProps> = ({ user, isOpen, setOpen }) => {
  ...
  const employeeLinks = [
    ...
    { to: '/submit-certificate', label: 'Enviar Atestado', icon: <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm-1 13v-3h-2v3H8l4 4 4-4h-3zm1-9V3.5L18.5 9H13z"/></svg> },
  ...
  const hrLinks = [
    ...
    { to: '/manage-certificates', label: 'Gerenciar Atestados', icon: <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor"><path d="M20 6v12h-2V8h-2V6h4V4h2v2h2v2h-4zM8 4c-1.11 0-2 .89-2 2v12c0 1.11.89 2 2 2h6c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2H8zm4 10h-2v2H8v-2H6v-2h2V8h2v4h2v2z"/></svg> },
